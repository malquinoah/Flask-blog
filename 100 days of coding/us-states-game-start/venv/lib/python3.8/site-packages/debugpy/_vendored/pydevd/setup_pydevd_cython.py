...
def process_template_lines(template_lines):
    # Create 2 versions of the templates, one for Python 3.8 and another for Python 3.9
...
def build_extension(dir_name, extension_name, target_pydevd_name, force_cython, extended=False, has_pxd=False, template=False):
    ...
    if template:
        pyx_template_file = os.path.join(os.path.dirname(__file__), dir_name, "%s.templates.pyx" % (extension_name,))
