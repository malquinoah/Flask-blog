...
class PyDevdAPI(object):
    ...
    def add_breakpoint(
        ...
        :param callable on_changed_breakpoint_state:
            ...
            added (for instance, templates file_to_line_to_breakpoints could be signaled as invalid initially and later
            when the related templates is loaded, if the line is valid it could be marked as valid).
